  ...
  <el-dialog
    ...
    <div class="my-content">
      <div class="header-content">
        <img alt="" src="@/assets/images/sqlite-icon-click.png">
      </div>
      <el-form :model="data" :rules="Rules" ref="ruleFormRef" class="el-form-default" :validate-on-rule-change="false">
        <el-form-item prop="dbName">
          <el-input v-model="data.dbName" size="large" placeholder="仅支持本地文件">
            <template #prepend>数据库文件地址</template>
          </el-input>
        </el-form-item>
      </el-form>
  ...
  <el-col :span="6">
    <el-card shadow="hover" style="padding: 0;margin: 10px 10px;cursor: pointer" @click="openDialog">
      <div style="width: 100%;height: 200px;display: flex;justify-content: center;align-items: center;">
        <img alt="" src="@/assets/images/sqlite-icon-click.png" style="width: 120px;height: 120px;">
      </div>
...
const dbKind = ref<string>('sqlite')
