  ...
  <el-dialog
    ...
    <div class="my-content">
      <div class="header-content">
        <img alt="" src="@/assets/images/postgresql-icon-click.png">
      </div>
  ...
  <el-col :span="6">
    <el-card shadow="hover" style="padding: 0;margin: 10px 10px;cursor: pointer" @click="openDialog">
      <div style="width: 100%;height: 200px;display: flex;justify-content: center;align-items: center;">
        <img alt="" src="@/assets/images/postgresql-icon-click.png" style="width: 120px;height: 120px;">
      </div>
...
const dbKind = ref<string>('postgresql')
